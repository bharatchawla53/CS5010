...
public interface StockView {
  ...
  /***
   * Method to prompt an existing user to select one of 6 options.
   * The 1st option loads a view to create a portfolio.
   * The 2nd option loads a view to let the user view the contents of a specific portfolio.
   * The 3rd option loads a view to calculate the total value of a portfolio.
   * The 4th option loads a view to allow a user to dump an existing portfolio.
   * The 5th option loads a view to allow a user to load an external portfolio.
   * The 6th option terminates the running of the application.
   */
