...
public class DollarCostAveragingPlan  implements StockPlan{
   ...
   * @param weightList the percentage of the capital to distribute to each transaction generated by.
   * the plan.
   * @param capital the total amount that the user wants to invest across all tickers and durations.
   * @param date_1 the date on which the user wishes to invest some amount into an portfolio.
   * @param date_2 the date the user wishes to stop investing some amount into an portfolio.
   * @param daySkip Every daySkip number of days, perform a transaction and add to the portfolio.
